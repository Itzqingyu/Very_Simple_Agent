...
class TokenTracker:
    ...
    def update(self, usage):
        """從 response.usage 累加 token（同時更新總計與單輪計數）"""
    ...
    @property
    def loop_cost(self):
        return (self.loop_input_tokens * self.INPUT_PRICE
              + self.loop_output_tokens * self.OUTPUT_PRICE)
    ...
    @property
    def total_cost(self):
        return (self.total_input_tokens * self.INPUT_PRICE
